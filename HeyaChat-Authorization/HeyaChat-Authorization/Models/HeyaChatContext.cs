...
public partial class HeyaChatContext : DbContext
{
    private IConfiguration _config;
    private IConfigurationRepository _repository;

    public HeyaChatContext()
    {
       
    }

    public HeyaChatContext(IConfiguration config, DbContextOptions<HeyaChatContext> options): base(options)
    {
